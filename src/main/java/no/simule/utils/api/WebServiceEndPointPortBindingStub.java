/**
 * WebServiceEndPointPortBindingStub.java
 * <p>
...
public class WebServiceEndPointPortBindingStub extends org.apache.axis.client.Stub implements WebServiceEndPoint {
    ...
    public WebServiceEndPointPortBindingStub() throws org.apache.axis.AxisFault {
        this(null);
    }

    public WebServiceEndPointPortBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        this(service);
        super.cachedEndpoint = endpointURL;
    }

    public WebServiceEndPointPortBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public boolean getResult(String arg0, byte[] arg1) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://service.api.esocl.simula.no/", "getResult"));
