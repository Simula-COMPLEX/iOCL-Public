...
import no.simule.reader.uml.ClassDiagramReader;
...
//        statics =
//                context.getApplication().evaluateExpressionGet(context, "#{statics}", StaticsBean.class);
    ...
    public void preRenderViewExperiment() {

//        if (name == null || name.isEmpty() || email == null || email.isEmpty()) {
//            try {
//                FacesContext.getCurrentInstance().getExternalContext().redirect("form.iocl");
//            } catch (Exception e) {
//                e.printStackTrace();
//            }
//            return;
...
//        }
    ...
    void beanInStack() {
        try {
            ...
            // logger.info("Size" + byteData.length);
            beanStack.push(byteData);
            //logger.info("Stack size: "+ObjectSizeFetcher.getObjectSize(byteData));
    ...
    public void resetAll() {
        ...
        panel.resetAll();
        statics.reset();
        property.setContexts(new ArrayList<String>());
    }


    public void loadModelExperiment() {
