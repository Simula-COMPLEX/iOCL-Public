...
public class PropertyBean implements Serializable {
    ...
    private List<String> contextOperations = new ArrayList<String>();
    ...
    private List<String> classOperations = new ArrayList<String>();
    ...
    private List<String> predefinedOperationParameters = new ArrayList<String>();
